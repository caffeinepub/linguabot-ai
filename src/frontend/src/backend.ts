...
import type { Message as _Message, Role as _Role, Time as _Time, UserPreferences as _UserPreferences } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async saveKnowledgeEntry(arg0: string, arg1: Array<string>, arg2: Array<[string, string]>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveKnowledgeEntry(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveMessage(arg0: string, arg1: string, arg2: Role): Promise<Message> {
        if (this.processError) {
            try {
                const result = await this.actor.saveMessage(arg0, arg1, to_candid_Role_n7(this._uploadFile, this._downloadFile, arg2));
    ...
    async setUserPreferences(arg0: string, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
